...
trips.interp.nomigr<-loc.interp.bassrock %>% 
                    trips_summary_ind(.,colony=colo_coord_bassrock) %>% 
...
summary(glmm.dist)
 ...
 plot_model(glmm.dist,type="pred",terms="day")
...
lattice::dotplot(ranef(glmm.dur))$id
 plot_model(glmm.dur,type="pred",terms="day")
...
plot_model(glmm.path,type="pred",terms="day")
```
